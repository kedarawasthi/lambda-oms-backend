...
public class OrderController {
    ...
    public ResponseEntity<String> placeSalesOrder(@Valid @RequestBody Salesorder salesorder, @RequestHeader Map<String,String> headers) {
        ...
        return new ResponseEntity<>("salesorder extended to customer service successfully, correlationId: " + headers.get("x-correlation-id"), HttpStatus.CREATED);
    }
    ...
    public ResponseEntity<String> placeReturnOrder(@Valid @RequestBody Returnorder returnorder,@RequestHeader Map<String,String> headers) {
        ...
        return new ResponseEntity<>("returnorder initiated to downstream systems successfully, correlationId: " + headers.get("x-correlation-id"), HttpStatus.CREATED);
    }
    ...
    public ResponseEntity<String> placePurchaseOrderToProductService(@Valid @RequestBody Purchaseorder purchaseorder,@RequestHeader Map<String,String> headers) {
        ...
        return new ResponseEntity<>("purchaseorder sent to product inventory successfully, correlationId: " + headers.get("x-correlation-id"), HttpStatus.CREATED);
    }
    ...
    public ResponseEntity<String> placePurchaseOrderToShippingService(@Valid @RequestBody Purchaseorder purchaseorder,@RequestHeader Map<String,String> headers) {
        ...
        return new ResponseEntity<>("purchaseorder sent to shipping service successfully, correlationId: " + headers.get("x-correlation-id"), HttpStatus.CREATED);
    }
}
